    ...
    const services = [
        {
            ...
            icon: <MdMultipleStop className="h-10 w-10 text-primary" />
        },
        {
            _id: 2,
            name: 'Car bulbs',
            description: 'Car bulbs are used to light the car.',
            icon: <HiLightBulb className="h-10 w-10 text-primary" />
        },
        {
            _id: 3,
            name: 'Air Filters',
            description: 'Air filters are used to clean the air inside the car.',
            icon: <SiAirchina className="h-10 w-10 text-primary" />
        },
        {
            _id: 4,
            name: 'Motors Oil',
            description: 'Motors oil is used to maximize the Engine  performance.',
            icon: <RiOilFill className="h-10 w-10 text-primary" />
        },
        {
            _id: 5,
            name: 'Spark Plugs',
            description: 'Spark plugs are used to start the engine.',
            icon: <GiFlintSpark className="h-10 w-10 text-primary" />
        }
    ]
    return (
        <>
