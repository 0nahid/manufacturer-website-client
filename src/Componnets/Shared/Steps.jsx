        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto flex flex-wrap">
                <div className="flex flex-wrap w-full">
                    ...
                    <img className="lg:w-3/5 md:w-1/2 object-cover object-center rounded-lg md:mt-0 mt-12" src="https://img.freepik.com/free-vector/car-parts-background-with-realistic-images-alloy-disks-steering-wheel-shock-absorbers-with-empty-space_1284-53973.jpg?w=2000" alt="step" />
                </div>
            </div>
        </section>
    )
